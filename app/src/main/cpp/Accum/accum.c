...
int inCTOS_UpdateAccumTotal(void)
{
    ...
    BYTE        szDCCBaseAmtBCD[12+1];
    BYTE        szDCCTipAmountBCD[12+1];
   ...
   memset(szDCCBaseAmtBCD, 0x00, sizeof(szDCCBaseAmtBCD));
   memset(szDCCTipAmountBCD, 0x00, sizeof(szDCCTipAmountBCD));
   wub_str_2_hex(szDCCBaseAmt, szDCCBaseAmtBCD, 12);
   wub_str_2_hex(szDCCTipAmount, szDCCTipAmountBCD, 12);
    ...
    switch(srTransRec.byTransType)
    {
            ...
            else
            {
                ...
                if(atol(szTipAmt) > 0)
                {
		           ...
		           if (srTransRec.fDCCOptin == TRUE)
                   {
                       ...
                       addBCD(srAccumRec.stBankTotal[inTranCardType].stDCCTotal[srTransRec.inCSTid].szSaleDCCTotalAmount, szDCCBaseAmtBCD, srAccumRec.stBankTotal[inTranCardType].stDCCTotal[srTransRec.inCSTid].szSaleDCCTotalAmount);					  
                       if (atol(szDCCTipAmount) > 0)	
                       {
							...
							addBCD(srAccumRec.stBankTotal[inTranCardType].stDCCTotal[srTransRec.inCSTid].szTipTotalDCCAmount, szDCCTipAmountBCD, srAccumRec.stBankTotal[inTranCardType].stDCCTotal[srTransRec.inCSTid].szTipTotalDCCAmount);
                       }
                       ...
                       DebugAddHEX("bcd.szSaleDCCTotalAmount", srAccumRec.stBankTotal[inTranCardType].stDCCTotal[srTransRec.inCSTid].szSaleDCCTotalAmount, 6);
                       DebugAddHEX("bcd.szTipTotalDCCAmount", srAccumRec.stBankTotal[inTranCardType].stDCCTotal[srTransRec.inCSTid].szTipTotalDCCAmount, 6);
                   }
            }			
        break;      
        ...
        case SALE_OFFLINE:
           ...
           if(srTransRec.fDCCOptin==TRUE)
           {
               ...
               addBCD(srAccumRec.stBankTotal[inTranCardType].stDCCTotal[srTransRec.inCSTid].szOffSaleTotalDCCAmount, szDCCBaseAmtBCD, srAccumRec.stBankTotal[inTranCardType].stDCCTotal[srTransRec.inCSTid].szOffSaleTotalDCCAmount);	
               if (atol(szDCCTipAmount) > 0)	
               {
                   srAccumRec.stBankTotal[inTranCardType].stDCCTotal[srTransRec.inCSTid].ulTipTotalDCCAmount+=atol(szDCCTipAmount);
        ...
        case PREAUTH_COMP_VOID:
            ...
            {                          
				...
				subtractBCD(srAccumRec.stBankTotal[inTranCardType].stDCCTotal[srTransRec.inCSTid].szCompTotalDCCAmount, szDCCBaseAmtBCD, srAccumRec.stBankTotal[inTranCardType].stDCCTotal[srTransRec.inCSTid].szCompTotalDCCAmount);	
				addBCD(srAccumRec.stBankTotal[inTranCardType].stDCCTotal[srTransRec.inCSTid].szVoidSaleTotalDCCAmount, szDCCBaseAmtBCD, srAccumRec.stBankTotal[inTranCardType].stDCCTotal[srTransRec.inCSTid].szVoidSaleTotalDCCAmount);	
            }
        break;
        ...
        case REFUND:
            ...
            if (srTransRec.fDCCOptin == TRUE)
            {
				...
				addBCD(srAccumRec.stBankTotal[inTranCardType].stDCCTotal[srTransRec.inCSTid].szRefundTotalDCCAmount, szDCCBaseAmtBCD, srAccumRec.stBankTotal[inTranCardType].stDCCTotal[srTransRec.inCSTid].szRefundTotalDCCAmount);	
            }
        break;
        ...
        case VOID:
            ...
            else if(srTransRec.byOrgTransType == PRE_COMP || srTransRec.byOrgTransType == PREAUTH_VER)
            {
                srAccumRec.stBankTotal[inTranCardType].stCardTotal[srTransRec.IITid].usVoidCompCount++;
                srAccumRec.stBankTotal[inTranCardType].stCardTotal[srTransRec.IITid].ulVoidCompTotalAmount = srAccumRec.stBankTotal[inTranCardType].stCardTotal[srTransRec.IITid].ulVoidCompTotalAmount + atol(szTransAmt);
		    ...
		    if (srTransRec.fDCCOptin == TRUE)
                      {                          
						  ...
						  subtractBCD(srAccumRec.stBankTotal[inTranCardType].stDCCTotal[srTransRec.inCSTid].szSaleDCCTotalAmount, szDCCBaseAmtBCD, srAccumRec.stBankTotal[inTranCardType].stDCCTotal[srTransRec.inCSTid].szSaleDCCTotalAmount);
                      }
            ...
            else if(srTransRec.byOrgTransType == SALE_OFFLINE)
            {
               ...
               if(srTransRec.fDCCOptin==TRUE)
               {
				  ...
				  addBCD(srAccumRec.stBankTotal[inTranCardType].stDCCTotal[srTransRec.inCSTid].szVoidSaleTotalDCCAmount, szDCCBaseAmtBCD, srAccumRec.stBankTotal[inTranCardType].stDCCTotal[srTransRec.inCSTid].szVoidSaleTotalDCCAmount);
				  subtractBCD(srAccumRec.stBankTotal[inTranCardType].stDCCTotal[srTransRec.inCSTid].szOffSaleTotalDCCAmount, szDCCBaseAmtBCD, srAccumRec.stBankTotal[inTranCardType].stDCCTotal[srTransRec.inCSTid].szOffSaleTotalDCCAmount);
               }
	     ...
	     if(srTransRec.fDCCOptin == TRUE)
               {
					...
					subtractBCD(srAccumRec.stBankTotal[inTranCardType].stDCCTotal[srTransRec.inCSTid].szRefundTotalDCCAmount, szDCCBaseAmtBCD, srAccumRec.stBankTotal[inTranCardType].stDCCTotal[srTransRec.inCSTid].szRefundTotalDCCAmount);
               }
            }
        break;
...
int inCTOS_UpdateAccumPreCompTotal(TRANS_DATA_TABLE *transData)
{
    ...
    if(transData->byTransType == PREAUTH_COMP)
    {
        ...
        {                          
			...
			addBCD(srAccumRec.stBankTotal[inTranCardType].stDCCTotal[srTransRec.inCSTid].szCompTotalDCCAmount, szDCCBaseAmtBCD, srAccumRec.stBankTotal[inTranCardType].stDCCTotal[srTransRec.inCSTid].szCompTotalDCCAmount);	
        }
	}
