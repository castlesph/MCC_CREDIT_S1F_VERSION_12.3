...
#define LOCAL_RECEIPT_FILE			"/data/data/com.Source.S1_MCC.MCC/fs_data/logo.bmp"
#define LOCAL_RECEIPT_FILE_NOLOGO	"/data/data/com.Source.S1_MCC.MCC/fs_data/nologo.bmp"
...
int inCTOSS_ERM_Form_Receipt(int inSettle)
{
	...
	BYTE szfilename[128];
	int inResult;	
	BYTE szSettleTotal[12];
	BYTE szFmtSettleTotal[20];
	ULONG ulERMSettleTotal = 0L;
	...
	if (d_OK == isCheckTerminalMP200() && (strTCT.byERMMode == 4))
	{
