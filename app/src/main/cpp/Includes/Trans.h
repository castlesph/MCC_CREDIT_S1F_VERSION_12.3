...
// sale completion
   ...
   ULONG  ulSaleDCCTotalAmount; 
    ...
    char szSaleDCCTotalAmount[6+1];
	char szRefundTotalDCCAmount[6+1];
	char szTipTotalDCCAmount[6+1];
	char szVoidSaleTotalDCCAmount[6+1];
	char szOffSaleTotalDCCAmount[6+1];
	char szCompTotalDCCAmount[6+1];
}STRUCT_TOTAL;
