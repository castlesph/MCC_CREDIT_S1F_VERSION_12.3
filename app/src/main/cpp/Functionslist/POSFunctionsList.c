...
Func_vdFunc stFunctionList_vdFunc[] = {
	...
	{"inPHQRLogin", inPHQRLogin},
	{"vdCTOS_DeleteBatchPassword", vdCTOS_DeleteBatchPassword},
	{"vdCTOS_SetWIFI", vdCTOS_SetWIFI},
    {"inSystemPanel", inSystemPanel},
 	{"", (DFUNCTION_LIST)NULL},
};
...
int inPHQRLogin(void)
{
	...
	vdDebug_LogPrintf("SATURN inPHQRLogin");
   ...
   inRet = inCTOS_MultiSwitchApp(szAppName, d_IPC_CMD_PHQR_LOGIN);
