...
//#define DB_BATCH	"./fs_data/V5S_MCCCREDIT.S3DB"
#define DB_BATCH	"/data/data/com.Source.S1_MCC.MCC/S1_MCC.S3DB"
...
#define DB_APPSELECTMENU "/data/data/com.Source.S1_MCC.MCC/DYNAMICMENU99.S3DB"
