package com.Source.S1_MCC.MCC.db;
...
*/
    ...
    public ArrayList<Cursor> getData(String Query){
        ...
        try{
            ...
            Log.d("printing exception 1", sqlEx.getMessage());
            //if any exceptions are triggered save the error message to cursor an return the arraylist
            Cursor2.addRow(new Object[] { ""+sqlEx.getMessage() });
            alc.set(1,Cursor2);
            return alc;
        } catch(Exception ex){
            Log.d("printing exception 2", ex.getMessage());
    ...
    public ArrayList<Cursor> updateTable(String table, ContentValues values, String whereClause, String[] whereArgs){
        ...
        alc.add(null);
        alc.add(null);
        Log.d("updateTable", table+ " values:" + values + " whereclause:" + whereClause + " whereargs:" + whereArgs);

        try{

            //execute the query results will be save in Cursor c
            Log.d("printing exception 3", table+ " values:" + values + " whereclause:" + whereClause + " whereargs:" + whereArgs);
            ...
            Log.d("printing exception 3", sqlEx.getMessage());
            //if any exceptions are triggered save the error message to cursor an return the arraylist
            Cursor2.addRow(new Object[] { ""+sqlEx.getMessage() });
            alc.set(1,Cursor2);
            return alc;
        } catch(Exception ex){
            Log.d("printing exception 4", ex.getMessage());
