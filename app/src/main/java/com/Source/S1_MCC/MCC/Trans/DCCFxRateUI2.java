...
public class DCCFxRateUI2 extends DemoAppActivity {

    Button dcc_currency;
    Button local_currency;
    Button cancel_button;
    Button dcc_print_currency;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dcc_fxrate2);
        ...
        textView_PrintType = (TextView) findViewById(R.id.textViewDCCPrintBtn);

        dcc_currency = (Button) findViewById(R.id.IPT_OKButton);
        local_currency = (Button) findViewById(R.id.btn_local_curr);
        dcc_print_currency = (Button) findViewById(R.id.btn_print_dcc);
        ...
        for (int inIdx = 0 ; inIdx < msgcnt; inIdx++)
        {
            ...
            switch (inIdx)
            {
                ...
                case 8:
                    textView_PrintType.setText(dispmsginfo[inIdx]);
                    String textViewDCCPrint = textView_PrintType.getText().toString();
                    if (textViewDCCPrint.equals("2"))
                        dcc_print_currency.setVisibility(View.VISIBLE);
                    else
                        dcc_print_currency.setVisibility(View.INVISIBLE);
        ...
        dcc_print_currency.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
