...
public class MenuTransactionType extends DemoAppActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mcc_popup_menu);
...
*/
        ...
        btn_title.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < TrxMenuItems.length; i++) {
                    ...
                    Log.i("saturn Image ID", MenuItems[i]);
    ...
    private AdapterView.OnItemClickListener popmenuItemClickListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		   ...
		   //use for S1F
		   MenuTransactionType.this.finish();
		   //use for S1F2
		   //new Handler().postDelayed(new Runnable() {
           //    public void run() {
		   //	       MenuTransactionType.this.finish();
    ...
    public void FuncKeyReports()
    {
        btn_reports.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.i("PATRICK", "MenuTransactionType REPORTS");
                // do whatever you need in child activity, but once you want to finish, do this and continue in parent activity
                synchronized (MainActivity.LOCK) {
                    MainActivity.LOCK.setCondition(true);
                    MainActivity.LOCK.notifyAll();
