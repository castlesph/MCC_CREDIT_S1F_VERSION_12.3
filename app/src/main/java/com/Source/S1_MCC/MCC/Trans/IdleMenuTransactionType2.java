...
public class IdleMenuTransactionType2 extends DemoAppActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mcc_idle_popup2);

        /* This code together with the one in onDestroy()
         * will make the screen be always on until this Activity gets destroyed. */
        final PowerManager pm = (PowerManager) getSystemService(Context.POWER_SERVICE);
        this.mWakeLock = pm.newWakeLock(PowerManager.SCREEN_DIM_WAKE_LOCK, "S1_MCC:AAA-IdleMenuTransactionType2>>WAKE_LOCK");
...
*/
        ...
        btn_title.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mccMenu = new TxnPopupMenu(getApplicationContext());
    ...
    private AdapterView.OnItemClickListener popmenuItemClickListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            */
            ...
            IdleMenuTransactionType2.this.finish();
    ...
    public void onBackPressed() {
        ...
        //startActivity(new Intent(DPopupMenuActivity.this,MainActivity.class));
        IdleMenuTransactionType2.this.finish();
        Log.i("PATRICK", "BackPressed IdleMenuTransactionType2");
