...
public class EditAdapter extends RecyclerView.Adapter<EditAdapter.MyViewHolder> {
    ...
    public EditAdapter(Context ct, String s1[], String s2[], String s3[], Integer s4[], Boolean s5[]){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        ...
        View view;// = inflater.inflate(R.layout.row_modifyfield_layout, parent, false);
        if(MainActivity.inTermType == 5)
			view = inflater.inflate(R.layout.row_modifyfield_layout_s1em, parent, false);
		else
			view = inflater.inflate(R.layout.row_modifyfield_layout, parent, false);
