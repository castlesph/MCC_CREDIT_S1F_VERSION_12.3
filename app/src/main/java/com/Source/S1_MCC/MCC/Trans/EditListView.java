...
public class EditListView extends DemoAppActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(MainActivity.inTermType == 5)
            setContentView(R.layout.activity_editdetail_s1em);
        else
        ...
        this.mWakeLock = pm.newWakeLock(PowerManager.SCREEN_DIM_WAKE_LOCK, "S1_MCC:AAA-EditListView>>WAKE_LOCK");
        ...
        EditAdapter EditAdapter = new EditAdapter(this, s1, s2, s3, s4, s6);
