...
public class GetCVVUI extends DemoAppActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_getcvv);

        /* This code together with the one in onDestroy()
         * will make the screen be always on until this Activity gets destroyed. */
        final PowerManager pm = (PowerManager) getSystemService(Context.POWER_SERVICE);
        this.mWakeLock = pm.newWakeLock(PowerManager.SCREEN_DIM_WAKE_LOCK, "S1_MCC:AAA-GetCVVUI>>WAKE_LOCK");
    ...
    private void FuncKey1() {
        btnKey1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                textView_detail2value.setText(userentry);
    ...
    private void FuncKeyCancel(){
        btnKeyCancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                GetCVVUI.this.finish();

                Log.i("PATRICK", "GetCVVUI KeyBoard buCancel");
        ...
        btnKeyEnter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //final_amt_string="12345678";
                    ...
                    Log.i("Tine", "GetCVVUI KeyBoard buOK");
