package com.Source.S1_MCC.MCC.db;//add your package name here example: package com.example.dbm;
...
import com.Source.S1_MCC.MCC.Main.DelayCode;
...
//				hsv.setVisibility(View.GONE);
				...
				/*Toast.makeText(getApplicationContext(),"Terminal will reboot please wait...",Toast.LENGTH_SHORT).show();
				//AAA
				int secs = 3;
	...
	public void updateDeletePopup(int row)
	{
		...
		for(int i=0;i<columnames.size();i++)
		{
			...
			EditText et = new EditText(getApplicationContext());
			//value_string.add(cv);
			et.setInputType(InputType.TYPE_TEXT_VARIATION_NORMAL|InputType.TYPE_CLASS_TEXT);
...
//				}
	...
	public void onBackPressed() {
		...
		info = null;
		Log.i("EDIT DB", "onClick BACK button");
		//Intent intent = new Intent();
		//intent.setClass(AndroidDatabaseManager.this, MainActivity.class);
		//startActivity(intent);
		final_string = "";
    ...
    public native int vdSetDbJournalMode();
}
