...
//        return false;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        tv_cmtstype = (TextView) findViewById(R.id.tv_cmtstype);
...
//            ctCtms.unbindService(Activity_ctms_update.this);
        ...
        intent.setClass(com.Source.S1_MCC.MCC.Main.Activity_ctms_background.this, MainActivity.class);
...
/*        try {
    ...
    public void vdFinishBackgroundActivity() {
        ...
        com.Source.S1_MCC.MCC.Main.Activity_ctms_background.this.finish();
        // do whatever you need in child activity, but once you want to finish, do this and continue in parent activity
        synchronized (MainActivity.LOCK) {
            MainActivity.LOCK.setCondition(true);
            MainActivity.LOCK.notifyAll();
...
//                    inCTOSS_SetDownloadedNotFinishedFlag(1);//20210127 for CTMS
    ...
    private void connectionInfo()
    {
        ...
        tv_cmtstype.setVisibility(View.VISIBLE);
        tv_cmtstype.setText("-BACKGROUND DOWNLOAD-");
